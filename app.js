...
function parseDump() {
  ...
  saveDumpItems([...existing, ...newItems]);
...
function removeDumpItem(id) {
  saveDumpItems(loadDumpItems().filter(i => i.id !== id));
  renderDump();
}
